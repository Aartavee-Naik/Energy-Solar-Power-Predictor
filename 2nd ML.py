...
# Load models
energy_model = jb.load(r"C:\Python Skill4Future Session\Solar_ML Model\solar_power_output(in).pkl")
solar_model = jb.load(r"C:\Python Skill4Future Session\Solar_ML Model\solar_power_output(in).pkl")

# Header
st.markdown("""
    <div style="text-align:center">
        <h1 style='color:#ff9933;'> EcoWatt: Smart Energy & Solar Predictor</h1>
